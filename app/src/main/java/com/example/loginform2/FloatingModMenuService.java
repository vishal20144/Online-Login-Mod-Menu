...
import static com.example.loginform2.StaticActivity.cacheDir;
...
public class FloatingModMenuService extends Service {
    ...
    private final int MENU_HEIGHT = 260; 
    ...
    public String moda = Prefs.with(this).read(MOD);
    ...
    private void initFloating() {
        ...
        gradientDrawable3.setColor(Color.parseColor("#53AEFC"));
        ...
        this.close.setShadowLayer(8.0f, 0.0f, 0.0f, -16777216);
        this.close.setPadding(3, 3, 3, 3);
        LinearLayout.LayoutParams layoutParamsClose = new LinearLayout.LayoutParams(-2, 60);
        layoutParamsClose.topMargin = 9;
        this.close.setLayoutParams(layoutParamsClose);
        ...
        gradientDrawable.setStroke(3, Color.parseColor("#53AEFC"));
        gradientDrawable.setCornerRadius(8.0f);
        mExpanded.setVisibility(8);
        mExpanded.setBackgroundColor(-65536);
        mExpanded.setBackground(gradientDrawable);
        mExpanded.setOrientation(1);
        mExpanded.setPadding(5, 0, 5, 0);
        mExpanded.setLayoutParams(new LinearLayout.LayoutParams(400, 500));
        ...
        this.patches.setBackgroundColor(-16777216);
        this.patches.setPadding(5, 5, 5, 5);
        this.patches.setBackground(gradientDrawable2);
        ...
        textView.setShadowLayer(12.0f, 0.0f, 0.0f, -16777216);
        ...
        patches.addView(textView2);
        patches.addView(textView3);
        patches.addView(textView4);
        patches.addView(textView5);
        patches.addView(textView6);*/
    ...
    private void initMenuButton(final View view2, final View view3) {
        ...
        kill.setOnClickListener(new View.OnClickListener() {
                public void onClick(View view) {
                    ...
                    Toast.makeText(kill.getContext(), "Menu Oculto Lembre - Se A Posição De Retorno!", Toast.LENGTH_LONG).show();
                }
            });
        close.setOnClickListener(new View.OnClickListener() {
                public void onClick(View view) {
                    ...
                    view3.setVisibility(View.GONE);
                    Toast.makeText(close.getContext(), "Fechado!", Toast.LENGTH_LONG).show();
                    //Log.i("LGL", "Close");
                }
            });
    }
    ...
    private void CreateMenuList() {
        ...
        for (int i = 0; i < listFT.length; i++) {
            ...
            } else if (str.contains("Menu_")) {
                Menu(str.replace("Menu_", ""));
    ...
    public void addButton(String feature, final InterfaceBtn interfaceBtn) {
        ...
        if (feature.contains("OnOff_")) {
            ...
            Toast.makeText(button.getContext(), ">OFF<", Toast.LENGTH_LONG).show();
            ...
            button.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (isActive) {
                            ...
                            button.setBackgroundColor(Color.TRANSPARENT);
                            Toast.makeText(button.getContext(), ">ON<", Toast.LENGTH_LONG).show();
                            ...
                            bt.setStroke(2, (Color.parseColor("#32CD32")));
                            bt.setColor(Color.parseColor("#32CD32"));
    ...
    private void addSwitch(String str, final InterfaceBool sw) {
        ...
        switchR.setText(Html.fromHtml("<font face='bold'><b>" + str + "</b></font>"));
    ...
    private void addSeekBar(String str,  int progress, int max, InterfaceInt sb) {
        ...
        sb2.append(str);
        sb2.append("<font face='monospace'><b>" + ": <font color='RED'>" + "" + "</b></font>");
        sb2.append(progress);
        sb2.append("</b>x</font>");
        ...
        seekbar.setShape(1);
        seekbar.setColor(Color.TRANSPARENT);
        seekbar.setStroke(dp(3), Color.parseColor("#00FF00"));
        seekbar.setCornerRadius(30.0f);
        ...
        seekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
                ...
                public void onProgressChanged(SeekBar seekBar, int i, boolean z) {
                    ...
                    if (i < i2) {
                        ...
                        textView.setText(Html.fromHtml("<font face='monospace'><b>" + str3 + ": <font color=WHITE'>" + i5 + "</b>x</font>"));
                        return;
                    }
                    sb3.OnWrite(i);
                    textView2.setText(Html.fromHtml("<font face='monospace'><b>" + str3 + ": <font color=WHITE'>" + i + "</b>x</font>"));
    ...
    private void addSeekBarSpot(final String feature, final int prog, int max, final InterfaceInt interInt) {
        ...
        linearLayout.setLayoutParams(layoutParams);
        final TextView textView = new TextView(this);
        textView.setText(Html.fromHtml("<font face='roboto'>" + feature + ": <font color='#FF0000'>" + "[ DESATIVADO ]" + "</font>"));
        ...
        seekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
                ...
                public void onProgressChanged(SeekBar seekBar2, int i, boolean z) {
                    if (i == 0) {
                        ...
                        interInt.OnWrite(i);
                        TextView textView = textView2;
                        textView.setText(Html.fromHtml("<font face='roboto'><b>" + feature + ": <font color='#41c300'>" + "Desativado" + "</b></font>"));
                    } else if (i == 1) {
                        seekBar2.setProgress(i);
                        interInt.OnWrite(i);
                        TextView textView = textView2;
                        textView.setText(Html.fromHtml("<font face='roboto'><b>" + feature + ": <font color='#41c300'>" + "Cabeça" + "</b></font>"));
                    } else if (i == 2) {
                        seekBar2.setProgress(i);
                        interInt.OnWrite(i);
                        TextView textView = textView2;
                        textView.setText(Html.fromHtml("<font face='roboto'><b>" + feature + ": <font color='#41c300'>" + "Corpo" + "</b></font>"));
                    } else if (i == 3) {
                        seekBar2.setProgress(i);
                        interInt.OnWrite(i);
                        TextView textView = textView2;
                        textView.setText(Html.fromHtml("<font face='roboto'><b>" + feature + ": <font color='#41c300'>" + "Pé" + "</b></font>"));
                    }
                    interInt.OnWrite(i);
                }
            });
    ...
    public void addButtonDarky(String str, BTN btn) {
        final GradientDrawable gradientDrawable = new GradientDrawable();
        gradientDrawable.setShape(0);
        gradientDrawable.setColor(Color.parseColor("#86FF5900"));
        gradientDrawable.setStroke(3, Color.parseColor("#86FF5900"));
        gradientDrawable.setCornerRadius(8.0f);
        final GradientDrawable gradientDrawable2 = new GradientDrawable();
        gradientDrawable2.setShape(0);
        gradientDrawable2.setColor(0);
        gradientDrawable2.setStroke(3, Color.parseColor("#86FF5900"));
        gradientDrawable2.setCornerRadius(8.0f);
        Button button = new Button(this);
    ...
    private void addSeekbarDarky(int i, final SB sb) {
        SeekBar seekBar = new SeekBar(this);
        seekBar.setMax(i);
        seekBar.getProgressDrawable().setColorFilter(Color.parseColor("#53AEFC"), Mode.MULTIPLY);
        seekBar.getThumb().setColorFilter(Color.parseColor("#53AEFC"), Mode.MULTIPLY);
    ...
    private void modMenu() {
        addButtonDarky("Auto - Aim", new BTN() {
                public void OnWrite(boolean z) {
                    FloatingModMenuService.this.changeToggle(0);
                }
            });
        addButtonDarky("Aim - Tiro", new BTN() {
                public void OnWrite(boolean z) {
                    FloatingModMenuService.this.changeToggle(1);
                }
            });
        addButtonDarky("Aim - Mira", new BTN() {
                public void OnWrite(boolean z) {
                    FloatingModMenuService.this.changeToggle(2);
                }
            });
        addSeekbarDarky(2, new SB() {
                TextView tv = FloatingModMenuService.this.addText("Aim Spot: Cabeça");

                public void OnWrite(int i) {
                    if (i == 1) {
                        this.tv.setText("Aim Spot: Pescoço");
                    } else if (i == 2) {
                        this.tv.setText("Aim Spot: Quadril");
                    } else {
                        this.tv.setText("Aim Spot: Cabeça");
                    }
                    FloatingModMenuService.this.changeSeekBar(26, i);
                }
            });
        addSeekbarDarky(360, new SB() {
                TextView tv = FloatingModMenuService.this.addText("Aim - Fov : 0x");

                public void OnWrite(int i) {
                    StringBuilder stringBuilder = new StringBuilder();
                    stringBuilder.append("Aim - Fov : ");
                    StringBuilder stringBuilder2 = new StringBuilder();
                    stringBuilder2.append(i);
                    stringBuilder2.append("x");
                    stringBuilder.append(stringBuilder2.toString());
                    this.tv.setText(stringBuilder.toString());
                    FloatingModMenuService.this.changeSeekBar(3, i);
                }
            });
        addSeekbarDarky(360, new SB() {
                TextView tv = FloatingModMenuService.this.addText("Aim - Puxada : 0x");

                public void OnWrite(int i) {
                    StringBuilder stringBuilder = new StringBuilder();
                    stringBuilder.append("Aim - Puxada : ");
                    StringBuilder stringBuilder2 = new StringBuilder();
                    stringBuilder2.append(i);
                    stringBuilder2.append("x");
                    stringBuilder.append(stringBuilder2.toString());
                    this.tv.setText(stringBuilder.toString());
                    FloatingModMenuService.this.changeSeekBar(5, i);
                }
            });
        addButtonDarky("Draw Fov", new BTN() {
                public void OnWrite(boolean z) {
                    FloatingModMenuService.this.changeToggle(6);
                }
            });
        addButtonDarky("Ze Pedrinha (Mapa Bermuda)", new BTN() {
                public void OnWrite(boolean z) {
                    FloatingModMenuService.this.changeToggle(17);
                }
            });
        addButtonDarky("Ghost Hack", new BTN() {
                public void OnWrite(boolean z) {
                    FloatingModMenuService.this.changeToggle(18);
                }
            });
        addButtonDarky("Teleport Hack", new BTN() {
                public void OnWrite(boolean z) {
                    FloatingModMenuService.this.changeToggle(19);
                }
            });
}
