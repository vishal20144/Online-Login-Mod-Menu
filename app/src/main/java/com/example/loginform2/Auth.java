...
public class Auth extends AsyncTask<String, Void, String> {
    ...
    protected void onPreExecute() {
        ...
        if (getDialog() != null) {
            getDialog().setMessage("Encontrando Usuario..");
            getDialog().show();
        }
    }
    ...
    protected void onPostExecute(String s) {
        ...
        try {
            ...
            if(data.get("Status").toString().equals("Success")) {
								...
								StaticActivity.Start(activity);
                                
                                try {
                                    Toast.makeText(activity,Html.fromHtml("<b><font color='pink'>Conectado! " + data.get("Dias").toString() + "</font>"), Toast.LENGTH_LONG).show();
